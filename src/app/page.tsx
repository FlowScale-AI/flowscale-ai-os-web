          ...
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-10 lg:gap-16">
            ...
            <div className="lg:max-w-md flex flex-col gap-8">
              <p className="text-base md:text-[21px] leading-[1.7] text-zinc-300 font-light">
                We help teams turn AI into real, usable systems — from ready-to-use solutions, to custom-built workflows tailored to your business.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                <a
                  href="https://cal.com/aman-flowscale/custom-development"
                  target="_blank"
                ...
                >
                  <span>Build a Custom AI System</span>
                </a>
              </div>
            </div>
          </div>
